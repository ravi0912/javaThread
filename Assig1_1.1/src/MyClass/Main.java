...
public class Main {
     ...
     * If empty then it will wait for the 1st element's input
    ...
    /**
     * Generating an ExecutorService(size 10)  and then starting the threads(Runnable1) one by one..
...
//        Main m = new Main();
        ...
        int i=0;
        while(i<10){
            executor.submit(new Runnable1(i));
            i++;
        }
        /**
